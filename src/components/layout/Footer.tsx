...
import { ArrowUp, Facebook, Twitter, Instagram, Github } from "lucide-react";
      ...
      <div className="relative container mx-auto px-6 py-16">
          ...
          >
            ...
            >
              <div className="p-2 bg-white/5 rounded-full group-hover:bg-cyan-400/20 transition-colors">
                <ArrowUp size={16} className="group-hover:text-cyan-400 transition-colors" />
              </div>
          ...
          >
            ...
            <ul className="space-y-3">
              {['About', 'Services', 'Portfolio', 'Contact'].map((link, index) => (
                ...
                >
                  <a href={`#${link.toLowerCase()}`} className="flex items-center gap-2">
            ...
            {isSubscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 py-3 rounded-lg font-semibold text-white hover:shadow-lg transition-all"
                >
                  Subscribe
                </motion.button>
              </form>
            ...
            <div className="flex items-center gap-4 pt-6">
              {[
                ...
                <motion.a
                  ...
                  href="#"
                  whileHover={{ y: -3 }}
                  className="p-2 rounded-full bg-white/5 border border-white/10 hover:border-white/20 transition-all"
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm">
            <p>© {new Date().getFullYear()} Sidify Solutions. All rights reserved.</p>
